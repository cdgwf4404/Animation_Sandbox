...
namespace FighterPackBundle{ //MODIFY
    [InitializeOnLoad]
    public class ReviewWindowEditor : EditorWindow{
		...
		private static string imagePath = "/Resources/Fighter-Pack-Bundle-Review.jpg"; //MODIFY
        ...
        [MenuItem("Window/Fighter Pack Bundle/Review")] //MODIFY
        static void Init(){
        ...
        void OnGUI(){		
            ...
            if (GUILayout.Button("Rate now!")){
				UnityEditorInternal.AssetStore.Open("content/23660"); //MODIFY
                DisableRating();
            }
